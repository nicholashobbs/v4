...
export default function ClientBench14({ template }: { template: Template }) {
  ...
  async function handleSeed() {
    // Seed contacts + empty target to make relative binding resolve after selection
  ...
  return (
    <main style={{ maxWidth: 960 }}>
      <h1>Benchmark 14 — Runtime targeting with field-picker (diff mode)</h1>
